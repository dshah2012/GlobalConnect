...
/**
 * Servlet implementation class EditTrainingExperience
 */
@WebServlet("/EditTrainingExperience")
public class EditTrainingExperience extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<WorkExperience> workExperiences=editProfileService.editTrainingExperience(trainingExpJson,trainerId);
